...
func TestDefaultGenesisBlock(t *testing.T) {
	...
	if block.Hash() != params.FandomMainnetGenesisHash {
		t.Errorf("wrong mainnet genesis hash, got %v, want %v", block.Hash().String(), params.FandomMainnetGenesisHash.String())
	}
...
func TestSetupGenesis(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			wantHash:   params.FandomMainnetGenesisHash,
			wantConfig: params.FandomMainnetChainConfig,
		},
		{
