...
func loadConfig(file string, cfg *fandomConfig) error {
	f, err := os.Open(file)
	if err != nil {
		return err
	}
...
func defaultNodeConfig() node.Config {
	...
	cfg.IPCPath = "fandom.ipc"
	return cfg
}

func makeConfigNode(ctx *cli.Context) (*node.Node, fandomConfig) {
	// Load defaults.
	cfg := fandomConfig{
...
func makeFullNode(ctx *cli.Context) (*node.Node, fandomConfig) {
