...
const (
	clientIdentifier = "fandom" // Client identifier to advertise over the network
)
...
var (
	...
	app = utils.NewApp(gitCommit, "the fandomchain command line interface")
...
func init() {
	// Initialize the CLI app and start fandom
	app.Action = fandom
	app.HideVersion = true // we have a command to print the version
	app.Copyright = "Copyright (c) 2018 Fandomchain"
...
// fandom is the main entry point into the system if no special subcommand is ran.
// It creates a default node based on the command line arguments and runs it in
// blocking mode, waiting for it to be shut down.
func fandom(ctx *cli.Context) error {
...
// miner.
func startNode(ctx *cli.Context, stack *node.Node, cfg fandomConfig) {
