...
func TestUDP_packetErrors(t *testing.T) {
	...
	test.packetIn(errExpired, pingFandom, &ping{From: testRemote, To: testLocalAnnounced, Version: Version})
...
func TestUDP_successfulPing(t *testing.T) {
	...
	go test.packetIn(nil, pingFandom, &ping{From: testRemote, To: testLocalAnnounced, Version: Version, Expiration: futureExp})
