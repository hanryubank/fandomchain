...
func (t *udp) ping(toid NodeID, toaddr *net.UDPAddr) error {
	...
	packet, hash, err := encodePacket(t.priv, pingFandom, req)
	if err != nil {
		return err
	}
...
func (t *udp) waitping(from NodeID) error {
	return <-t.pending(from, pingFandom, func(interface{}) bool { return true })
}
...
func (req *ping) handle(t *udp, from *net.UDPAddr, fromID NodeID, mac []byte) error {
	...
	if !t.handleReply(fromID, pingFandom, req) {
