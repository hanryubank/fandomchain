...
func GetRewardBalancesRate(foudationWalletAddr common.Address, masterAddr common.Address, totalReward *big.Int, validator *contractValidator.FandomValidator) (map[common.Address]*big.Int, error) {
...
func GetCandidatesOwnerBySigner(validator *contractValidator.FandomValidator, signerAddr common.Address) common.Address {
	owner := signerAddr
	opts := new(bind.CallOpts)
